      ...
      <div className="flex h-16 items-center border-b px-4">
        {!collapsed && (
          <Link to="/admin" className="flex items-center gap-2">
            <img src="/images/sp-logo.png" alt="SP Granites" className="h-8 w-8 object-contain block dark:hidden" />
            <img src="/images/sp-logo-dark.png" alt="SP Granites" className="h-8 w-8 object-contain hidden dark:block" />
