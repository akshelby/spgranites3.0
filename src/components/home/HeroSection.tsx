          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-center gap-3 mt-1.5">
                ...
                <span className="brand-tagline text-sm sm:text-base text-gray-900 dark:text-white tracking-[0.25em] uppercase font-black hero-tagline-glow">Premium Stone Works</span>
