...
export function CategoriesSection() {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-24 bg-background" data-testid="categories-section">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-black text-foreground leading-tight tracking-tight" data-testid="text-categories-title">
            {t('categories.title')}
          </h2>
