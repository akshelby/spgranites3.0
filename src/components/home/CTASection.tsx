...
export function CTASection() {
  ...
  return (
    <section className="py-8 sm:py-10 lg:py-14 bg-black text-white relative overflow-hidden" data-testid="cta-section">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h3 className="text-lg sm:text-2xl lg:text-3xl font-display font-bold mb-2 sm:mb-4 heading-stylish text-emerald-300" data-testid="text-cta-title">
            {t('cta.title')}
          </h3>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-5 sm:gap-6 justify-center items-center">
            <Link
              to="/estimation"
              className="cta-ribbon-btn cta-ribbon-btn-cta-dark group"
