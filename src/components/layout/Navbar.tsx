    ...
    >
      <div className="container mx-auto px-4">
        <nav className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-1.5 overflow-x-auto max-w-[calc(100%-360px)] scrollbar-hide border-2 border-red-600 rounded-xl px-3 py-1.5 bg-muted/40 mr-2">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                to={link.href}
