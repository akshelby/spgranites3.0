      ...
      <div className="container mx-auto px-4">
        <nav className="flex items-center justify-between h-16 lg:h-20">
          <Link to="/" className="flex items-center gap-2.5 group">
            <img src="/images/sp-logo.png" alt="SP Granites" className="w-20 h-20 object-contain dark:hidden" />
            <img src="/images/sp-logo-dark.png" alt="SP Granites" className="w-20 h-20 object-contain hidden dark:block" />
          </Link>
