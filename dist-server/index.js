...
function registerRoutes(app2) {
  ...
  app2.post("/api/auth/callback", async (req, res) => {
    try {
  ...
  app2.post("/api/auth/signout", async (_req, res) => {
  ...
  app2.get("/api/catalogs", async (_req, res) => {
    try {
  ...
  app2.post("/api/catalogs/:id/download", async (req, res) => {
    try {
  ...
  app2.get("/api/hero-carousel/cards", async (_req, res) => {
    try {
  ...
  app2.get("/api/hero-carousel/settings", async (_req, res) => {
    try {
  ...
  app2.get("/api/store-locations", async (_req, res) => {
    try {
  ...
  app2.get("/api/contact-numbers", async (_req, res) => {
    try {
  ...
  app2.post("/api/estimation-enquiries", async (req, res) => {
    try {
  ...
  app2.post("/api/site-visitors", async (req, res) => {
    try {
  ...
  app2.put("/api/profile", requireAuth, async (req, res) => {
    try {
      const userId = req.user.id;
      const { data, error } = await supabase.from("profiles").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("user_id", userId).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.put("/api/addresses/:id", requireAuth, async (req, res) => {
    try {
      const userId = req.user.id;
      const { data, error } = await supabase.from("addresses").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", req.params.id).eq("user_id", userId).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.post("/api/product-reviews", requireAuth, async (req, res) => {
    try {
      const userId = req.user.id;
  ...
  app2.get("/api/conversations", async (req, res) => {
    try {
      ...
      if (ref_id) {
        const { data: conv, error: error2 } = await supabase.from("conversations").select("*").eq("ref_id", ref_id).maybeSingle();
  ...
  app2.put("/api/admin/conversations/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { data, error } = await supabase.from("conversations").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", req.params.id).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.get("/api/admin/products", requireAuth, requireAdmin, async (_req, res) => {
    try {
  ...
  app2.put("/api/admin/products/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { data, error } = await supabase.from("products").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", req.params.id).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.get("/api/admin/categories", requireAuth, requireAdmin, async (_req, res) => {
    try {
  ...
  app2.put("/api/admin/categories/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { data, error } = await supabase.from("product_categories").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", req.params.id).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.put("/api/admin/orders/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { data, error } = await supabase.from("orders").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", req.params.id).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.get("/api/admin/enquiries", requireAuth, requireAdmin, async (_req, res) => {
    try {
  ...
  app2.put("/api/admin/enquiries/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { data, error } = await supabase.from("enquiries").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", req.params.id).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.delete("/api/admin/enquiries/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.get("/api/admin/estimations", requireAuth, requireAdmin, async (_req, res) => {
    try {
  ...
  app2.put("/api/admin/estimations/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { data, error } = await supabase.from("estimation_enquiries").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", req.params.id).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.put("/api/admin/product-reviews/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.put("/api/admin/customer-reviews/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { data, error } = await supabase.from("customer_reviews").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", req.params.id).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.delete("/api/admin/product-reviews/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.delete("/api/admin/customer-reviews/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.get("/api/admin/testimonials", requireAuth, requireAdmin, async (_req, res) => {
    try {
  ...
  app2.put("/api/admin/testimonials/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { data, error } = await supabase.from("testimonials").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", req.params.id).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.get("/api/admin/services", requireAuth, requireAdmin, async (_req, res) => {
    try {
  ...
  app2.post("/api/admin/services", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.put("/api/admin/services/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { data, error } = await supabase.from("services").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", req.params.id).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.delete("/api/admin/services/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.get("/api/admin/catalogs", requireAuth, requireAdmin, async (_req, res) => {
    try {
  ...
  app2.post("/api/admin/catalogs", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.put("/api/admin/catalogs/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { data, error } = await supabase.from("catalogs").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", req.params.id).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.delete("/api/admin/catalogs/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.get("/api/admin/banners", requireAuth, requireAdmin, async (_req, res) => {
    try {
  ...
  app2.post("/api/admin/banners", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.put("/api/admin/banners/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { data, error } = await supabase.from("banners").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", req.params.id).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.delete("/api/admin/banners/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.get("/api/admin/carousel/cards", requireAuth, requireAdmin, async (_req, res) => {
    try {
  ...
  app2.post("/api/admin/carousel/cards", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.put("/api/admin/carousel/cards/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { data, error } = await supabase.from("hero_carousel_cards").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", req.params.id).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.delete("/api/admin/carousel/cards/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.put("/api/admin/carousel/settings", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { data: existing } = await supabase.from("hero_carousel_settings").select("*").limit(1).maybeSingle();
      if (existing) {
        const { data, error } = await supabase.from("hero_carousel_settings").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", existing.id).select().single();
        if (error) throw error;
        res.json(data);
      } else {
  ...
  app2.get("/api/admin/locations", requireAuth, requireAdmin, async (_req, res) => {
    try {
  ...
  app2.post("/api/admin/locations", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.put("/api/admin/locations/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { data, error } = await supabase.from("store_locations").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", req.params.id).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.delete("/api/admin/locations/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.get("/api/admin/contact-numbers", requireAuth, requireAdmin, async (_req, res) => {
    try {
  ...
  app2.post("/api/admin/contact-numbers", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.put("/api/admin/contact-numbers/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { data, error } = await supabase.from("contact_numbers").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", req.params.id).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.delete("/api/admin/contact-numbers/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.put("/api/admin/users/:id/role", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { role } = req.body;
  ...
  app2.get("/api/admin/dashboard", requireAuth, requireAdmin, async (_req, res) => {
    try {
  ...
  app2.get("/api/admin/conversations", requireAuth, requireAdmin, async (_req, res) => {
    try {
      const { data, error } = await supabase.from("conversations").select("*").order("last_message_at", { ascending: false });
      if (error) throw error;
      res.json(data);
  ...
  app2.get("/api/admin/leads", requireAuth, requireAdmin, async (_req, res) => {
    try {
  ...
  app2.post("/api/admin/leads", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.put("/api/admin/leads/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { data, error } = await supabase.from("leads").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", req.params.id).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.delete("/api/admin/leads/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.get("/api/admin/crm-notes", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.post("/api/admin/crm-notes", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.delete("/api/admin/crm-notes/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.get("/api/admin/crm-followups", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { lead_id, user_id } = req.query;
  ...
  app2.post("/api/admin/crm-followups", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.put("/api/admin/crm-followups/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
      const { data, error } = await supabase.from("crm_followups").update({ ...req.body, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", req.params.id).select().single();
      if (error) throw error;
      res.json(data);
    } catch (error) {
      res.status(500).json({ error: error.message });
  ...
  app2.delete("/api/admin/crm-followups/:id", requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  app2.get("/api/admin/crm/overview", requireAuth, requireAdmin, async (_req, res) => {
    try {
